% file : CouplingStructure.tex
% author : Alicia Wang, Total SA
% date : May 2013
% Structure of code coupling for the vibro-acoustic simulation.
%------------------------------------------------------------------------------
...
\begin{tikzpicture}[node distance = 30mm, every node/.style={scale=0.8}]
	...
	\node (VACoupling)   [term, below of = cent, node distance = 60mm]  {Vibro-acoustic library};
...
% 	\node		   (PoroVACoupling)[term, right of = HPoroSolver, fill=gray!30, node distance = 43mm] {Air/Poro-elastic/Solid coupling};
 	...
 	\node (VAnote) [red, below of = VACoupling, node distance = 10mm] {Manage the two libraries for the global iterative methods};
